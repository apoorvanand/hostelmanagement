...
Devise.setup do |config|
  ...
  # config.secret_key = 'your_key_here'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'no-reply@vesta.app'
  ...
  # lookup. For instance, if you set :request_keys to
  # [:subdomain], :subdomain will be used on authentication.
  ...
  # using other algorithms, it sets how many times you want the
  ...
  # config.pepper = '4be3ea67ef2315795a1a27c20ed0d802674743f40773d7c2d72e39b4'\
  #                 '12cf8bc1bebac375d2cd19e611126ef2105e3a9c8c90d2f9c35d085a'\
  #                 'a2ca9132a542d237'
  ...
  # :failed_attempts = Locks an account after a number of failed signin attempts
  ...
  # :time  = Re-enables login after an amount of time (see :unlock_in below)
  ...
  # change the failure app, you can configure them inside this block.
  #
